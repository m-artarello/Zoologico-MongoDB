...
public abstract class MenuAnimal {
    ...
    public static void cadastrarAnimal(MongoDatabase db) { // Responsável pelo cadastro de novos animais
        Scanner scanner = new Scanner(System.in);
    ...
    public static void buscarAnimais (MongoDatabase db){ // Busca todos os profissionais do banco de dados
        AnimalDAO animalDAO = new AnimalDAO(db);
    ...
    public static void buscarAnimaisPorProfissional(MongoDatabase db){ // Busca os animais relacionadas à um profissional específico
        AnimalDAO animalDAO = new AnimalDAO(db);
        Scanner scanner = new Scanner(System.in);
    ...
    public static void buscarAnimaisSemServicoNoDia(MongoDatabase db){ // Busca os animais que ainda nao tiveram nenhum servico no dia
        AnimalDAO animalDAO = new AnimalDAO(db);
        Scanner scanner = new Scanner(System.in);
